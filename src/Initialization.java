...
public class Initialization {
    ...
    public static void addLabelTextSiteField(String labelText, JTextField field, GridBagConstraints constraints) {
    ...
    public static void addLabelTextEmailField(String labelText, JTextField field, GridBagConstraints constraints) {
        JLabel label = new JLabel(labelText);
        label.setFont(new Font("CALIBRE", Font.ITALIC, 15));
        label.setForeground(Color.black);
        constraints.gridx = 0;
